...
<template>
  <v-container class="text-center mt-8">
    <v-row>
      <v-col cols="0" md="2"/>
      <v-col cols="12" md="8">
        <div class="text-h2 text-center font-weight-medium">Let PassKeeper free your memory</div>
      </v-col>
      <v-col cols="0" md="2"/>
    </v-row>
    ...
    <v-row>
      <v-col cols="0" md="2"/>
      <v-col cols="12" md="8">
        <div class="text-h6 text-center">All of your passwords, credit cards, and personal info in a single secure place.
        </div>
      </v-col>
      <v-col cols="0" md="2"/>
    </v-row>
